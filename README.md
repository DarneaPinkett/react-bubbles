...
a token is used for authenticating users, making sure that only those who are approved to view a page can access it.

- [ ] What steps can you take in your web apps to keep your data secure?

By using protected routes to make sure that only people who are logged in or has the credentials can view pages with confidential info and https can ensure data sent over internet is encrypted

- [ ] Describe how web servers work.

a web server stores copies of data, including web pages and multipedia, to be served to clients.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

c: create/add r: retrieve/get u: update/put d: delete
